class StudentBehaviorResponse {
  final String? status;
  final String? message;
  final List<StudentBehaviorData>? students;
  ...
  factory StudentBehaviorResponse.fromJson(Map<String, dynamic> json) {
    return StudentBehaviorResponse(
      status: json['status'],
      message: json['message'],
      students: (json['data']['students'] as List<dynamic>?)
          ?.map((e) => StudentBehaviorData.fromJson(e))
          .toList(),
      keyPoints: (json['data']['keyPoints'] as List<dynamic>?)
          ?.map((e) => KeyPointData.fromJson(e))
          .toList(),
      result: json['result'],
    );
  }
...
class StudentBehaviorData {
  ...
  factory StudentBehaviorData.fromJson(Map<String, dynamic> json) {
