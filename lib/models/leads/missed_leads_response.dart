...
class MissedLeadsResponse {
  ...
  factory MissedLeadsResponse.fromJson(Map<String, dynamic> json) {
    return MissedLeadsResponse(
      status: json['status'],
...
class FollowUpData {
  final List<FollowUpStatus> followUpStatus;
  final List<AllFollowUp> allFollowUp;

  FollowUpData({
    required this.followUpStatus,
    required this.allFollowUp,
  });

  factory FollowUpData.fromJson(Map<String, dynamic> json) {
    return FollowUpData(
      followUpStatus: (json['followUpStatus'] as List)
          .map((e) => FollowUpStatus.fromJson(e))
          .toList(),
      allFollowUp: (json['allFollowUp'] as List)
          .map((e) => AllFollowUp.fromJson(e))
          .toList(),
    );
  }
}
...
class AllFollowUp {
  ...
  factory AllFollowUp.fromJson(Map<String, dynamic> json) {
    return AllFollowUp(
      fId: json['f_id'] ?? '',
      cId: json['c_id'] ?? '',
      lId: json['l_id'] ?? '',
