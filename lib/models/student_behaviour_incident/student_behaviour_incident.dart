class StudentBehaviorIncidentResponse {
  final String status;
  final String message;
  final List<BehaviorIncidentData> data;
  final bool result;

  StudentBehaviorIncidentResponse({
  ...
  factory StudentBehaviorIncidentResponse.fromJson(Map<String, dynamic> json) {
    return StudentBehaviorIncidentResponse(
      status: json['status'] ?? '',
      message: json['message'] ?? '',
      data: (json['data'] as List)
          .whereType<Map<String, dynamic>>()
          .map((e) => BehaviorIncidentData.fromJson(e))
          .toList(),
...
class BehaviorIncidentData {
  ...
  factory BehaviorIncidentData.fromJson(Map<String, dynamic> json) {
    return BehaviorIncidentData(
      id: json['id'] ?? '',
      ...
      ssid: json['ssid'] ?? '',
      totalIncident: json['totalIncident'] ?? '',
