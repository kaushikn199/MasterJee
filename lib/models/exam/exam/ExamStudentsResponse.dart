class ExamStudentsResponse {
  ...
  factory ExamStudentsResponse.fromJson(Map<String, dynamic> json) {
    return ExamStudentsResponse(
      status: json['status'] ?? '',
...
class Student {
  ...
  factory Student.fromJson(Map<String, dynamic> json) {
    return Student(
      ...
      isLeave: json['is_leave'] ?? '0',
      isActive: json['is_active'] ?? 'yes',
      isAlumni: json['is_alumni'] ?? '0',
      defaultLogin: json['default_login'] ?? '0',
